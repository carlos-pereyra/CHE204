...
plot "../../data/output.dat" using 1:2 with points linestyle 1 title '$V(r)$', \
     "../../data/output.dat" using 1:3 with points linestyle 2 title '$-\nabla_iV(r)$', \
     
#     1 with line linestyle 4 title '$3 k_b T / 2 = 0.45 E_0$'
